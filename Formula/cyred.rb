class Cyradar < Formula
  ...
  on_macos do
    on_arm do
      url    "https://github.com/cybrium-ai/cyred/releases/download/v0.1.5/cyred_0.1.5_aarch64-apple-darwin.tar.gz"
      sha256 "8dc98d5120865714e4a742dbf344c274c355a730de6846c83f1e261a91f7c3d6"
    end
    on_intel do
      url    "https://github.com/cybrium-ai/cyred/releases/download/v0.1.5/cyred_0.1.5_x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url    "https://github.com/cybrium-ai/cyred/releases/download/v0.1.5/cyred_0.1.5_aarch64-unknown-linux-gnu.tar.gz"
      sha256 "f46be999d04aa722b585742ad40efa1a3fcb11aaa9c0a144d7d8877c31ef0481"
    end
    on_intel do
      url    "https://github.com/cybrium-ai/cyred/releases/download/v0.1.5/cyred_0.1.5_x86_64-unknown-linux-gnu.tar.gz"
