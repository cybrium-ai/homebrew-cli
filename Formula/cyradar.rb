class Cyradar < Formula
  ...
  on_macos do
    on_arm do
      url    "https://github.com/cybrium-ai/cyradar-releases/releases/download/v0.1.8/cyradar_0.1.8_aarch64-apple-darwin.tar.gz"
      sha256 "09837267dfd9dd9ac4d266cc2f88fe1ce35cef9a35d3bb1fb5d4eee683dcaac4"
    end
    on_intel do
      url    "https://github.com/cybrium-ai/cyradar-releases/releases/download/v0.1.8/cyradar_0.1.8_x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url    "https://github.com/cybrium-ai/cyradar-releases/releases/download/v0.1.8/cyradar_0.1.8_aarch64-unknown-linux-gnu.tar.gz"
      sha256 "2ed2a03303bd2f977f02405de6e2b1ff6bdc7dfc9bb3e7ece62f36e92758ee2d"
    end
    on_intel do
      url    "https://github.com/cybrium-ai/cyradar-releases/releases/download/v0.1.8/cyradar_0.1.8_x86_64-unknown-linux-gnu.tar.gz"
