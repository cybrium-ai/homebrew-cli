class Cyradar < Formula
  ...
  on_macos do
    on_arm do
      url    "https://github.com/cybrium-ai/cyradar-releases/releases/download/v0.1.9/cyradar_0.1.9_aarch64-apple-darwin.tar.gz"
      sha256 "789091ec3996badac5b065bdeba1ff2d76a95798bd7d786dd06b90548d7b38ae"
    end
    on_intel do
      url    "https://github.com/cybrium-ai/cyradar-releases/releases/download/v0.1.9/cyradar_0.1.9_x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url    "https://github.com/cybrium-ai/cyradar-releases/releases/download/v0.1.9/cyradar_0.1.9_aarch64-unknown-linux-gnu.tar.gz"
      sha256 "409218753c691d3f051cd8a389a2e53a51e28d3138fc43b15a3e3cfcaa9ab8c5"
    end
    on_intel do
      url    "https://github.com/cybrium-ai/cyradar-releases/releases/download/v0.1.9/cyradar_0.1.9_x86_64-unknown-linux-gnu.tar.gz"
